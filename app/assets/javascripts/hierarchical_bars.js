function hierarchicalGraphInit(id, data_path, initial_date, final_date)
{
  ...
  d3.json(data_path + ".json?initial_date=" + initial_date + "&final_date=" + final_date, function(root)
  {
