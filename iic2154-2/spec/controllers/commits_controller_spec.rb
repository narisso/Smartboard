  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved commit as @commit" do
        ...
        post :create, {:commit => { "url" => "invalid value" }}, valid_session
        assigns(:commit).should be_a_new(Commit)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested commit" do
        ...
        Commit.any_instance.should_receive(:update_attributes).with({ "url" => "MyString" })
        put :update, {:id => commit.to_param, :commit => { "url" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the commit as @commit" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Commit.any_instance.stub(:save).and_return(false)
        put :update, {:id => commit.to_param, :commit => { "url" => "invalid value" }}, valid_session
        assigns(:commit).should eq(commit)
      end
