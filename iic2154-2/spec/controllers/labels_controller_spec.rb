  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved label as @label" do
        ...
        post :create, {:label => { "name" => "invalid value" }}, valid_session
        assigns(:label).should be_a_new(Label)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested label" do
        ...
        Label.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => label.to_param, :label => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the label as @label" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Label.any_instance.stub(:save).and_return(false)
        put :update, {:id => label.to_param, :label => { "name" => "invalid value" }}, valid_session
        assigns(:label).should eq(label)
      end
