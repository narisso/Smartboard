  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved requirement as @requirement" do
        ...
        post :create, {:requirement => { "name" => "invalid value" }}, valid_session
        assigns(:requirement).should be_a_new(Requirement)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested requirement" do
        ...
        Requirement.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => requirement.to_param, :requirement => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the requirement as @requirement" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Requirement.any_instance.stub(:save).and_return(false)
        put :update, {:id => requirement.to_param, :requirement => { "name" => "invalid value" }}, valid_session
        assigns(:requirement).should eq(requirement)
      end
