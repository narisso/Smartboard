  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved test as @test" do
        ...
        post :create, {:test => { "task_id" => "invalid value" }}, valid_session
        assigns(:test).should be_a_new(Test)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested test" do
        ...
        Test.any_instance.should_receive(:update_attributes).with({ "task_id" => "1" })
        put :update, {:id => test.to_param, :test => { "task_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the test as @test" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Test.any_instance.stub(:save).and_return(false)
        put :update, {:id => test.to_param, :test => { "task_id" => "invalid value" }}, valid_session
        assigns(:test).should eq(test)
      end
