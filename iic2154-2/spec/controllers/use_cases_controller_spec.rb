  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved use_case as @use_case" do
        ...
        post :create, {:use_case => { "name" => "invalid value" }}, valid_session
        assigns(:use_case).should be_a_new(UseCase)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested use_case" do
        ...
        UseCase.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => use_case.to_param, :use_case => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the use_case as @use_case" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        UseCase.any_instance.stub(:save).and_return(false)
        put :update, {:id => use_case.to_param, :use_case => { "name" => "invalid value" }}, valid_session
        assigns(:use_case).should eq(use_case)
      end
