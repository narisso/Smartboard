  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved evaluation as @evaluation" do
        ...
        post :create, {:evaluation => { "task_id" => "invalid value" }}, valid_session
        assigns(:evaluation).should be_a_new(Evaluation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested evaluation" do
        ...
        Evaluation.any_instance.should_receive(:update_attributes).with({ "task_id" => "1" })
        put :update, {:id => evaluation.to_param, :evaluation => { "task_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the evaluation as @evaluation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Evaluation.any_instance.stub(:save).and_return(false)
        put :update, {:id => evaluation.to_param, :evaluation => { "task_id" => "invalid value" }}, valid_session
        assigns(:evaluation).should eq(evaluation)
      end
